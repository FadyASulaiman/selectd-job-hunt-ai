...
Jun 7 2025
Dubugged and tested LLM API calls, gemini now verified working through the API call for Job description. Tested models: Gemini-2.5-Pro and Gemini-2.5-flash. Unit and integration tests.
